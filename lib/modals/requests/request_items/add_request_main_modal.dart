...
class AddRequestMainItem extends StatefulWidget {
  final Function(int) onSelectIndex;

  AddRequestMainItem({required this.onSelectIndex});

  @override
  _AddRequestMainItemState createState() => _AddRequestMainItemState();
}

class _AddRequestMainItemState extends State<AddRequestMainItem>{
  ...
  Future<List<Map<String, dynamic>>> fetchMainProducts() async {
    try {
      final data = await DatabaseHelper.getMainBranchStocks();
        ...
        flexibleSpace: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              const Text(
                "| Request Items From Main Branch",
